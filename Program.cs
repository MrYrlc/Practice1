...
*/
        ...
        static void Main(string[] args)
        {
            ...
            while(true)
            {
                ...
                Console.WriteLine("5,Modify player information");
                Console.WriteLine("6,Exit");
                Console.WriteLine("---------------------------------------");
                Console.Write("Please enter the options according to your needs :");
                string input = Console.ReadLine();
                int num_1;
                if (int.TryParse(input,out num_1 )&& num_1 >0 && num_1 <7)
                {
                    if(num_1 == 1)
                    {
                        int marketvalue;
                        ...
                        bool exists = PlayerInformations.Any(p => p.name.Equals(name, StringComparison.OrdinalIgnoreCase));
                        if (exists)
                        {
                    ...
                    else if (num_1 == 3)
                    {
                        while (true)
                        {
                            ...
                            if (num == 1)
                            {
                                ...
                                string SearchPlayerName = Console.ReadLine().ToLower();
                                foreach (var player in PlayerInformations)
                                {
                                    if (player.name.ToLower().Contains(SearchPlayerName))
                                    {
                                        found = true;
                                        player.show();
                                    }
                            ...
                            else if (num == 2)
                            {
                                ...
                                string SearchPlayerNation = Console.ReadLine().ToLower();
                                foreach (var player in PlayerInformations)
                                {
                                    if (player.nation.ToLower().Contains(SearchPlayerNation))
                                    {
                                        found = true;
                                        player.show();
                                    }
                            ...
                            else if (num == 3)
                            {
                                ...
                                string SearchPlayerClub = Console.ReadLine().ToLower();
                                foreach (var player in PlayerInformations)
                                {
                                    if (player.club.ToLower().Contains(SearchPlayerClub))
                                    {
                                        found = true;
                                        player.show();
                                    }
                            ...
                            else if (num == 4)
                            {
                                ...
                                string SearchPlayerPositon = Console.ReadLine().ToLower();
                                foreach (var player in PlayerInformations)
                                {
                                    if (player.position.ToLower() == SearchPlayerPositon)
                                    {
                                        found = true;
                                        player.show();
                                    }
                    ...
                    {
                        Console.WriteLine("Please enter the name of the player you want to modify :");
                        ...
                        foreach (var player in PlayerInformations)
                        {
                            if (player.name.ToLower() == name)
                            {
                                ...
                                Console.WriteLine("3,Positon");
                                Console.WriteLine("4,Ability");
                                Console.WriteLine("5,MarketValue");
                                Console.WriteLine("6,Exit");
                                Console.Write("Please select the information you want to modify :");
                                string a = Console.ReadLine();
                                int b;
                                if (int.TryParse(a , out b) && b>0 && b < 7)
                                {
                                    if (b == 1)
                                    {
                                        Console.Write("Please enter your modified information :");
                                        string newclub = Console.ReadLine();
                                        player.club = newclub;
                                        Console.WriteLine("Success.Now the player's new information is :");
                                        player.show();
                                    }
                                    else if (b == 2)
                                    {
                                        ...
                                        int newage;
                                        if (int.TryParse(input, out newage) && newage > 0 && newage < 60)
                                        {
                                            player.age = newage;
                                            Console.WriteLine("Success.Now the player's new information is :");
                                            player.show();
                                    ...
                                    {
                                        Console.Write("Please enter your modified information :");
                                        string newpositon = Console.ReadLine();
                                        player.position = newpositon;
                                        Console.WriteLine("Success.Now the player's new information is :");
                                        player.show();
                                    }
                                    else if (b == 4)
                                    {
                                        ...
                                        input = Console.ReadLine();
                                        int newability;
                                        if (int.TryParse(input, out newability) && newability > 0 && newability < 100)
                                        {
                                    ...
                                    else if (b == 5)
                                    {
                                        ...
                                        input = Console.ReadLine();
                                        int newvalue;
                                        if (int.TryParse(input, out newvalue) && newvalue > 0)
                                        {
